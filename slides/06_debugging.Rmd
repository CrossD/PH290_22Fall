...
`options(error=recover)` can useful here
...
- Tracedown and confirmation

- Bipartite method (when you have no idea what happened at all and the code doesn't run)
...
- If others wrote the bug, or the bug is complicated
