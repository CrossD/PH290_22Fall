...
- This is as opposed to *dynamic scoping*, which look up the value of a global variable depends on how a function is called
...
- But do be wary about the argument names clashes (input)
...
2\. Be able to let function depend on system statuses where/when the function is defined/run
