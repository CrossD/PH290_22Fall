...
- We will be using "/" to separate parent/child directories
...
- Integrated development environments (IDEs)
    ...
    - Other IDEs: [Visual Studio](https://docs.microsoft.com/en-us/visualstudio/rtvs/?view=vs-2017), [Nvim-r for vim](https://github.com/jalvesaq/Nvim-R), and [ESS for emacs](http://ess.r-project.org/). 
